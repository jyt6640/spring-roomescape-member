...
@SpringBootTest(
        ...
        properties = "spring.sql.init.data-locations=classpath:empty-data.sql"
)
...
public class MissionStepTest {
    ...
    void 예약과_시간_연결() {
        ...
        jdbcTemplate.update("INSERT INTO theme (name, description, thumbnail) VALUES (?, ?, ?)", "공포", "무서움", "/images/theme/1.jpg");
