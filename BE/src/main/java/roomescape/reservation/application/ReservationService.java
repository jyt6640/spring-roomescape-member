...
public class ReservationService {
    ...
    public void updateReservationSchedule(LocalDate date, Long timeId, Long id, String name) {
        ...
        validateName(name);
        ReservationTime time = reservationTimeRepository.findById(timeId)
                .orElseThrow(() -> new EntityNotFoundException("예약 수정에 필요한 예약 시간을 찾을 수 없습니다. timeId: %d"
                        .formatted(timeId))
                );
        Reservation pastReservation = reservationRepository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("수정할 예약을 찾을 수 없습니다. reservationId: %d"
                        .formatted(id))
                );
    ...
    public void deleteReservationByName(Long id, String name) {
        ...
        Reservation reservation = reservationRepository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("취소할 예약을 찾을 수 없습니다. reservationId: %d"
                        .formatted(id))
                );
